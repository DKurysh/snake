...
class SnakeEnv(gym.Env):
    ...
    def __init__(self, size=SIZE, render_zoom=20, start_position=None, start_direction_index=None,
                 food_position=None):
    ...
    def render(self, close=False):
        ...
        if not close:
            ...
            return self.renderer.render(self.world.get_observation(), close=False)
